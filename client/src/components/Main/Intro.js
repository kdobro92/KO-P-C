    ...
    <div className="intro-container">
      <div className="intro-inner">
        <div className="intro-image">
          <img className="intro-img" src="img/main2.png" alt="intro" />
        </div>
        <div className="intro-sub">
          <p>
            <span>미래를 움직일 수 있는 힘</span>은
          </p>
          ...
          <p>스티브 잡스의 명언처럼 실천하는 혁신적인 KO-P&C TEAM이</p>
          <p>되어 건설산업의 미래를 이끌어 나가는 원동력이 될 것입니다.</p>
        </div>
      </div>
    </div>
  );
